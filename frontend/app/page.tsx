...
export default function Home(){
 ...
 const sound=useDemoAudio(source==='demo'&&playing,elapsed,source==='demo');
 ...
 },[applyPacket,sound.start,sound.stop]);
 ...
 return <><StarBackdrop playing={active&&!stale} gentle={gentle} sleepProgress={sleepProgress}/><main className={immersive?'app immersive filament-app':'app filament-app'}>
  <header className="topbar"><a className="brand" href="/" aria-label="渐静首页"><Waves size={28}/><strong>渐静</strong><span>JIANJING</span></a><div className="header-note">身心之间，看见变化</div><span className="prototype">交互原型 <span>07</span></span></header>
