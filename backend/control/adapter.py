...
from backend.control.models import ControlFrame, ControlPayload, DebugState, Guidance, MAX_SAFE_INTEGER, DataSource
...
class ControlAdapter:
    ...
    def snapshot(self, frame: Frame, *, include_debug: bool = True, data_source: DataSource = "simulated") -> ControlFrame:
        if self.visual is None:
        ...
        packet = ControlFrame(session_id=self.session_id, seq=self.next_seq, timestamp=frame.timestamp, data_source=data_source,
